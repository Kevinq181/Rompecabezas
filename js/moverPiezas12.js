...
//Asignación del tamaño a cada una de las 12 piezas  
...
for (var i = 0; i < piezas.length; i++) {
    ...
    piezas[i].setAttribute("y", Math.floor((Math.random() * 300) + 1));
...
function testing() {
    ...
    //Si el contador tiene el valor de 12 es decir que todas las piezas estan en la ubicacion correcta
    if (bien_ubicada == 12) {
